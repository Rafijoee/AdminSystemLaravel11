...
class PaymentController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // Pastikan file 'paymentsub' telah diunggah sebelum memprosesnya
        if ($request->hasFile('paymentsub')) {
            try {
                ...
                DB::rollBack();
                dd($e); // Tampilkan pesan kesalahan untuk debugging
                return redirect()->back()->with('error', 'Gagal upload file pembayaran');
            }
        } else {
