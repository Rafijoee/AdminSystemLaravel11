    ...
    <div class=" bg-white rounded-2xl border-2 mx-20 my-10">
        ...
        <div class="mt-10 px-20 ">
            ...
            @if ($fileOnUpload)
                ...
                <h2 class="text-1xl text-red-500 font-semibold my-6">Your file will be replaced with the latest one if you upload
                    again.</h2>
            @else
            ...
            <form id="submission-form" action="/final-submission" method="POST" enctype="multipart/form-data">
                ...
                <button type="submit"
                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 my-10 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Submit</button>
            </form>
