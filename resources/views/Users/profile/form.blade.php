        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <form action="/profile" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-lg shadow-md space-y-6">
                ...
                <div class="mb-6">
                    ...
                    <span class="text-red-600"> *Kamu tidak bisa mengubah data kategori lomba jika tim kamu sudah menggunggah file ke submission</span>z
                    @error('category_id')
                    <div class="text-sm text-red-600 mt-2">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-6">
                    ...
                    <select name="univ" id="univ" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
