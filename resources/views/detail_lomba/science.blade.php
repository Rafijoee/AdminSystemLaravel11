    ...
    <div class="container  mx-auto mt-20 flex justify-center">
        <div class="container-main bg-slate-50 w-2/3 relative justify-center mb-10 rounded-md"> 
            <div class="content-atas mb-6 text-center mt-10">
                ...
                <a href="{{ route('download', ['name' => 'RULE BOOK ICT SCIENTIFIC PAPER ITC 2024.pdf']) }}" class="px-3 py-1 text-[10px] text-center text-white bg-blue-700 rounded-md hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 absolute top-0 right-0 mt-2 mr-[260px]">‎  RULEBOOK  ‎</a>
