                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('download', ['filename' => urlencode($kti['path_3'])]) }}" class="font-medium text-[#40C6A1] hover:underline">{{ $kti['path_3']}}</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('download', ['filename' => urlencode($busplan['path_3'])]) }}" class="font-medium text-[#40C6A1] hover:underline">{{ $busplan['path_3']}}</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('download', ['filename' => urlencode($ux['path_3'])]) }}" class="font-medium text-[#40C6A1] hover:underline">{{ $ux['path_3']}}</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
                    ...
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                                ...
                                <td class="px-6 py-4">
                                    <a href="{{ route('download', ['filename' => urlencode($ppl['path_3'])]) }}" class="font-medium text-[#40C6A1] hover:underline">{{ $ppl['path_3']}}</a>
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
